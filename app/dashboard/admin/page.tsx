...
export default function AdminDashboard() {
  ...
  const stats = [
    {
      ...
      change: "+5.2%",
      trend: "up",
      bgClass: "from-primary to-blue-alt",
    },
    {
      ...
      change: "+2",
      trend: "up",
      bgClass: "from-secondary to-amber-300",
    },
    {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-white to-blue-mint/10 page-transition">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <div className="grid gap-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
              ...
              <div className="flex gap-4">
                ...
                <Link href="/admin/beasiswa/tambah">
                  <Button className="gradient-button text-white rounded-full shadow-glow btn-press">
          ...
          <section>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {stats.map((stat, index) => (
                <Card key={index} className="border-none shadow-soft rounded-3xl overflow-hidden card-hover">
          ...
          <section className="grid md:grid-cols-2 gap-6">
            <Card className="shadow-soft rounded-3xl border-none overflow-hidden card-hover">
              <CardHeader className="bg-gradient-to-r from-blue-light/50 to-blue-mint/50">
              ...
              <CardContent className="p-6">
                <div className="h-[300px] flex items-center justify-center bg-blue-mint/10 rounded-2xl">
                  <div className="text-center p-4">
                    <BarChart3 className="h-16 w-16 mx-auto text-primary/30 mb-4 animate-bounce-slow" />
            ...
            <Card className="shadow-soft rounded-3xl border-none overflow-hidden card-hover">
              <CardHeader className="bg-gradient-to-r from-secondary/30 to-amber-200">
                <CardTitle className="flex items-center">
              ...
              <CardContent className="p-6">
                <div className="h-[300px] flex items-center justify-center bg-secondary/5 rounded-2xl">
                  <div className="text-center p-4">
                    <PieChart className="h-16 w-16 mx-auto text-secondary/30 mb-4 animate-bounce-slow" />
          ...
          <section>
            <Card className="shadow-soft rounded-3xl border-none overflow-hidden">
              <CardHeader className="flex flex-row items-center justify-between bg-gradient-to-r from-green-200 to-teal-100">
                <div>
                  <CardTitle className="flex items-center">
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody>
                      {aplikasiTerbaru.map((aplikasi) => (
                        <tr
                          key={aplikasi.id}
                          className="border-b last:border-0 hover:bg-blue-mint/10 transition-colors"
                        >
                          ...
                          <td className="py-4 px-4 text-right">
                            <Link href={`/admin/aplikasi/${aplikasi.id}`}>
                              <Button
                                variant="ghost"
                                size="sm"
                                className="text-primary hover:bg-blue-mint/30 rounded-full"
                              >
